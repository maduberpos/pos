...
.directive('rnStepper', function() {
    return {
        ...
        template: '<button type="button" ng-disabled="isOverMin()" ng-click="decrement()"><i class="icon ion-android-remove-circle"></i></button>' +
                  '<input type="text" ng-model="ngModel" readonly>' +
                  '<button type="button" ng-disabled="isOverMax()" ng-click="increment()"><i class="icon ion-android-add-circle"></i></button>',
